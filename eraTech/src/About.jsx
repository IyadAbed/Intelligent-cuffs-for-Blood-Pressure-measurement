                ...
                <div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
                    <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                        <div className="flex flex-col items-center justify-center">
                            <h1 className="md:text-5xl my-10 text-3xl font-bold text-center text-gray-800">مؤسسة رغد الرواشدة للريادة والابتكار كف ضغط الدم</h1>
                            <p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600">من نحن ومن نستهدف ومن المستفيدين!!</p>
                            <div className="md:mt-14 mt-12 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">شركتنا ناشئة متخصصة في تطوير الأجهزة الطبية. تقع في إربد وتعتزم تصميم وبراءات الاختراع وتسويق الأجهزة والأدوات الطبية المتعلقة بمراقبة فرط ضغط الدم وتشخيصه وعلاجه وإدارته.</p>
                            </div>
